...
<template>
  <div class="relative box-border h-full w-full flex flex-col items-center justify-center px-8"
    ...
    <div class="text-xl font-semibold text-white mb-2">Thanks for answering!</div>
    <div class="text-3xl mb-3 font-semibold text-white text-center"> Let’s get started with your adventure.</div>
    <img src="/boy-toss.png" alt="welcomeIMG" class="h-[380px] w-[380px] " />
    <div class="text-2xl text-white text-center mb-5">Congratulations! You’ve earned 500 XP!</div>
